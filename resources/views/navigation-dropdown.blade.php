    ...
    <div class="max-w-7xl  px-4 md:px-6 lg:px-8 ">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links -->
                <div class="hidden space-x-5 md:space-x-8 font-semibold ml-2 md:-my-px lg:ml-32 md:flex " style="text-shadow: rgb(0,250,150) 3px 3px 5px; ">
            ...
            <div class="hidden md:flex md:items-center md:ml-6">
                ...
                <x-jet-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <x-jet-dropdown-link href="{{ route('profile.show') }}" class="hover:bg-green-300">
                            {{ __('Profile') }}
                        </x-jet-dropdown-link>
                        
                        @if (Laravel\Jetstream\Jetstream::hasApiFeatures())
                            <x-jet-dropdown-link href="{{ route('api-tokens.index') }}" class="hover:bg-green-300">
                                {{ __('API Tokens') }}
                            </x-jet-dropdown-link>
                        @endif
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <x-jet-dropdown-link href="{{ route('logout') }}"
                                                onclick="event.preventDefault();
                                                            this.closest('form').submit();" class="hover:bg-red-300">
                                {{ __('Logout') }}
                            </x-jet-dropdown-link>
                        </form>
                    </x-slot>
